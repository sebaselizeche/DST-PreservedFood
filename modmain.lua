...
AddRecipe("preserved_bananapop", {Ingredient("bananapop", getConfig("cfgPreservedBananaPop")), nitre and Ingredient("nitre", getConfig("cfgNitre")) or nil}, recipeTab, recipeTech, nil, nil, true, nil, nil, "images/inventoryimages/bananapop.xml")
